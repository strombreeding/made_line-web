...
const CombinedGraph = () => {
  ...
  const maxValue = Math.max(...itemList.map((item) => Math.max(item.매출, item.영업이익)));
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* <Tooltip /> */}
        {/* <Legend /> */}
        <Bar radius={[10, 10, 0, 0]} dataKey="매출" barSize={7} fill="#5CC3B5" name="매출" />
      ...
      <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }}>
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
          <div style={{ width: 10, height: 10, backgroundColor: '#5CC3B5', borderRadius: 100 }} />
          <EmptyArea width={5} />
          <span style={{ fontSize: 12, fontWeight: 700, color: '#767676' }}>영업이익</span>
        </div>
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
          <div style={{ width: 10, height: 10, backgroundColor: '#D2EFEB', borderRadius: 100 }} />
          <EmptyArea width={5} />
          <span style={{ fontSize: 12, fontWeight: 700, color: '#767676' }}>매출</span>
        </div>
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
          <div style={{ width: 10, height: 10, backgroundColor: '#958FFC', borderRadius: 100 }} />
          <EmptyArea width={5} />
